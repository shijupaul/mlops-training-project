...
def main():
    df = load_dataset('data/machine_failure_train.csv')
    ...
    with mlflow.start_run(run_name="Random Forest Classifier"):
        classifier = RandomForestClassifier(n_estimators = 100, criterion = 'entropy', max_depth=8, random_state = 42) 
        ...
        report_path = "artifact/classification_report.txt"
